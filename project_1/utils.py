...
def plot_classification_dataset(X, y, colors = ['r', 'b', 'g', 'y'], xticks=[], yticks=[], title="", show_legend=True, savefig_path=None):
    """
    ...
    if X.shape[1] == 2:
        ...
        plt.scatter(X[:, 0], X[:, 1], c=list(map(lambda i: colors[i], y)), edgecolor='k', s=20)
